...
- **Weather Forecast** — Shows temperature, current condition, current icon, hourly (8 hours), and daily (5 days) forecasts with condition-specific backgrounds. Icons are high-resolution 512×512 Meteocons auto-discovered by WMO weather code.
  - Also shows time in the selected city. When Wi-Fi is off the clock keeps ticking, the weather disappears.
